...
if (
  ...
  UserName = 'User'
  document.getElementById('front-introduction').innerText =
    '" Hey User, Secure your Account Information on Internet with SaveNet "'
} else if (
  UserName != null ||
  UserName != undefined ||
  UserName != '' ||
  ...
  document.getElementById('front-introduction').innerText =
    `" Hey ${UserName}, Secure your Account Information on Internet with SaveNet "`
...
const maintext_type_animation = new Typed('.maintext', {
  strings: [
...
setInterval(() => {
  const loging = localStorage.getItem('AccountID')
  console.log(loging)
...
document
  .getElementById('contactus-button')
  .addEventListener('click', contactus)
